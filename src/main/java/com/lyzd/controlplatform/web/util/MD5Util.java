...
public class MD5Util {
    ...
    public static void main(String[] args) {
        ...
        String mm = MD5Util.generate(password);
        System.out.println(mm);
        System.out.println(MD5Util.verify("123456", MD5Util.generate(password)));
    }
}
